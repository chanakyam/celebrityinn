...
shell:
	erl -pa ebin -pa deps/*/ebin -eval "[application:start(App) || App <- [syntax_tools, compiler, jsx, ibrowse, erlydtl, goldrush,lager, ranch, cowlib, crypto, cowboy, celebrityinn ] ]."
